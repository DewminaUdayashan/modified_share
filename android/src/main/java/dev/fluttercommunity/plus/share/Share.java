...
class Share {
    ...
    void shareFiles(List<String> paths, List<String> mimeTypes, String text, String subject, String packageNameOptional)
            throws IOException {
        ...
        if (!packageNameOptional.equals("default"))
            shareIntent.setPackage(packageNameOptional);
